	...
	: m_World(nullptr), m_LastFrameTime(0.0f)
{
    ...
    auto& transf2 = entity2.GetComponent<StrikeEngine::TransformComponent>();
    auto& transf3 = entity3.GetComponent<StrikeEngine::TransformComponent>();
    
    transf1.Rotation = glm::vec3(270.f, 0.f, 45.f);
...
void Sandbox3D::OnAttach()
{
    ...
    StrikeEngine::ScreenPanel* pipView2 = activeView->AddScreen(glm::vec2(-0.25f), glm::vec2(0.25f));
...
{
    auto& transf1 = m_TestEntity1.GetComponent<StrikeEngine::TransformComponent>();
    transf1.Rotation += glm::vec3(0.f, 45.f,0.f);
}
